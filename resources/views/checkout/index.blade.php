...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
            <form action="/check-shipping" method="get" class="login_form">
                
                    <div class="login-form"><!--login form-->
                        <input type="hidden" name="_token" value="{{csrf_token()}}">

                        <legend class="text-center">Pengiriman</legend>
                        ...
                        <button type="submit" name="submit" class="primary-btn">Cek Ongkir</button>
                        </div>
                    </div><!--/login form-->
            ...
            <div class="col-lg-4">
                <form action="/order-review" method="get" class="login_form">
                    ...
                    <legend class="text-center">Harga</legend>
                    ...
                    <div style="text-align: center;">
                        <button type="submit" name="submit" class="primary-btn">Review Order</button>
                    </div>
                </form>
            </div>
            @endif
